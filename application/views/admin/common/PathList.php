...
<head>
    ...
    <script src="/static/js/dms/rightTab.js"></script>
...
<div class="tools">
<div class="tools-left tools-left-explorer hidden">
...
<div class='bodymain drag-upload-box menu-body-main' style="top:40px" id="orgDrag">
...
<script>
    $(document).ready(function() {
        ...
        var params = {};
        params.prtId = prtId;
        commobj.dlist("dmsListTable", G.paths+"dms/pageList", params, true, dmsListObj.onSelectDms, dmsListObj.ponDblClickDms);
