                ...
                <div class="tools-left tools-left-explorer ">
                    ...
                    <div class="kod-toolbar kod-toolbar-path fl-left">
                        <div class="select-button-show btn-group btn-group-sm fl-left mr-8 fldBtn b2" style="display: none">
                            <button data-action='upload' class="btn btn-default" type="button" data-toggle="modal" data-target="#createFolder" onclick="dmsListObj.showCreateFolder()" >
                        ...
                        <div class="select-button-show btn-group btn-group-sm fl-left mr-8 docBtn b3" style="display: none">
                            <button data-action="upload" class="btn btn-default" type="button" data-toggle="modal" onclick="docUploadObj.showUpload('upload')" style="position: relative;">
                                <i class="font-icon icon-cloud-upload"></i><?php echo $this->lang->line('Upload_document')?></button>
                            <button data-action="upload-more" class="btn btn-default tool-path-upload" type="button" id="arrow" style="position: relative;">
                                <i class="font-icon icon-caret-down"></i>
                            </button>
                        </div>
                        <div class="select-button-show btn-group btn-group-sm fl-left mr-8 singleDocBtn b6" style="display: none">
                            <button data-action='proces' class="btn btn-default" type="button" data-toggle="modal" onclick="dmsListObj.Addproces()" style="position: relative;">
                                <i class="font-icon icon-location-arrow"></i><?php echo $this->lang->line('Add_to_the_process')?></button>
                                <button data-action="upload-more" class="btn btn-default tool-path-upload" type="button" id="editproces" style="position: relative;">
                                <i class="font-icon icon-caret-down"></i>
                            </button>
                        </div>
...
<!-- 个人文档管理模块 start-->
<div class='bodymain drag-upload-box menu-body-main' id="orgDrag">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content" style="border: 1px solid #cccccc;">
            <div class="modal-header">
                <button type="button" class="close cClose" onclick="dmsListObj.refresh()" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    ...
                    <form class="form-horizontal">
                        <div class="form-group ">
                            ...
                            <div class="col-xs-8 ">
                                ...
                                <p class="cabNameHip" style="color: red; display: none;" id="noCabName" ><?php echo $this->lang->line('CabName')?></p>
                                <p class="cabNameHip" style="color: red; display: none;" id="existSameCabName"><?php echo $this->lang->line('SameCabName')?></p>
                            </div>
                        </div>
                        <div class="form-group">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-xs btn-xs btn-green" onclick="dmsListObj.createCabinet('orgDoc')"><?php echo $this->lang->line('save')?></button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="updateCabinet" role="dialog" aria-labelledby="gridSystemModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content" style="border: 1px solid #cccccc;">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-xs btn-xs btn-white closeModel" data-dismiss="modal"><?php echo $this->lang->line('cancel')?></button>
                <button type="button" class="btn btn-xs btn-xs btn-green" onclick="dmsUpdateObj.updateCabinet('orgDoc')"><?php echo $this->lang->line('save')?></button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="createFolder" role="dialog" aria-labelledby="gridSystemModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content" style="border: 1px solid #cccccc;">
            ...
            <div class="modal-footer">
                <button onclick="dmsListObj.refresh()" type="button" class="btn btn-xs btn-xs btn-white closeMode" data-dismiss="modal"><?php echo $this->lang->line('closeMode')?></button>
            </div>
        </div>
    </div>
</div>
<!--弹出窗口 <?php echo $this->lang->line('Create_folder')?> end-->
                    ...
                    <div class="tab-pane fade in active" id="outShare">
                        <table style="margin-top: 10px;">
                            ...
                            <tr style="height: 40px">
                                ...
                                <td>
                                    <input name="curlRevName" type="text" id="curlRevName" required>
                                </td>
                            </tr>
                            <tr style="height: 40px">
                                <td>
...
<script type="application/javascript" src="/static/js/autocomplete.js"></script></script>
