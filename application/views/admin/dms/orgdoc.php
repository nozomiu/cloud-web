            ...
            <div class="tools">
                <div class="tools-left tools-left-explorer ">
                    ...
                    <div class="kod-toolbar kod-toolbar-path fl-left">
                        <div class="select-button-default btn-group btn-group-sm fl-left zip mr-8 b1">
                        ...
                        <div class="select-button-show btn-group btn-group-sm fl-left mr-8 docBtn b3" style="display: none">
                            <button data-action='upload' class="btn btn-default" type="button" data-toggle="modal" onclick="docUploadObj.showUpload('upload')" >
